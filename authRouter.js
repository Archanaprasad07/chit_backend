...
router.post('/user/register', async (req, res) => {
  try {
    const { userId, username, password, name, email, phone, address, chitId } = req.body;
    ...
    const newUser = new User({ userId, username, password, name, email, phone, address, chitId });
